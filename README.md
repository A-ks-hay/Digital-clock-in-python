# Smart Digital Clock using Python & Tkinter
...
time() function updates time every second.

apply_theme() dynamically changes UI colors.

OptionMenu allows theme switching.
